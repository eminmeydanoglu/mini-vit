"""
ViT for Masked Patch Prediction on CIFAR-10.

ViT architecture (Dosovitskiy et al., 2020) adapted for self-supervised
learning via masked patch reconstruction (similar to MAE, He et al., 2022).
"""
...
class ViT(nn.Module):
    """Vision Transformer for Masked Patch Prediction."""
...
def create_vit(
    ...
    """Factory function for ViT with custom config."""
    config = ViTConfig(
        embed_dim=embed_dim,
        depth=depth,
        num_heads=num_heads,
