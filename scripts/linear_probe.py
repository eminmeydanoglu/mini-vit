...
from src.model import ViT, ViTConfig
...
class LinearProbe(nn.Module):
    ...
    def __init__(self, encoder: ViT, num_classes: int = 10):
        super().__init__()
...
def load_pretrained_encoder(checkpoint_path: str) -> ViT:
    config = ViTConfig()
    model = ViT(config)
...
if __name__ == "__main__":
    train_linear_probe("checkpoints/mini_vit_epoch_300.pth")
